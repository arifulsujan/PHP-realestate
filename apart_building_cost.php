...
<div class="sub-banner">
    <div class="container">
        <div class="breadcrumb-area">
            <h1>Apartment Building & Construction</h1>
            <ul class="breadcrumbs">
                <li><a href="index.html">Home</a></li>
                <li class="active">Apartment Building & Construction</li>
            </ul>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                <div class="about-info">
                    <img class="d-block w-100" src="img/properties/home-blueprint.jpg" alt="Third slide">
                </div>
            </div>
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                <div class="about-text">
                    <h3>Apartment Building & Construction</h3>
