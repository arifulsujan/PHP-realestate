        ...
        <div class="row">
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                <div class="footer-item clearfix">
                    <img src="img/bu_builders_logo_w.png" alt="BU Builders Logo" class="f-logo">
                    <div class="text">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <p class="copy">Copyright © 2020 <a href="#">BU Builders</a>, All Rights Reserved.</p>
                </div>
...
<div id="full-page-search">
    ...
    <form action="http://theme-vessel-templates.theme-vessel.ey.r.appspot.com/neer/index.html#">
